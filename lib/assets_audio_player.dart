...
class AssetsAudioPlayer {
  ...
  final BehaviorSubject<bool> _isPlaying = BehaviorSubject<bool>()..add(false);
  ...
  final BehaviorSubject<bool> _finished = BehaviorSubject<bool>()..add(false);
  ...
  final BehaviorSubject<Duration> _currentPosition = BehaviorSubject<Duration>()
    ..add(const Duration());
